...
export default function Nav() {
  ...
  return (
    <nav className='w-full z-40 sticky top-0 my-0 flex items-stretch justify-between bg-my-orange py-0 lg:bg-my-beige'>
      <Link
        href='/'
      ...
      <div className='items-right flex justify-between bg-my-orange lg:bg-my-beige'>
        ...
        >
          <Link
            className='cursor-pointer p-4 duration-500 lg:my-0 lg:hover:text-my-orange lg:hover:animate-wiggle'
          ...
          <Link
            className='cursor-pointer p-4 duration-500 lg:my-0 lg:hover:text-my-orange hover:animate-wiggle'
