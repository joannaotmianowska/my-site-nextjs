    ...
    <>
      <div className='z-10 px-10 lg:px-0 flex flex-col lg:flex-row xl:w-3/4'>
        <div className='grid place-content-center grow'>
          ...
          <h3 className='py-2 font-bold font-hand'>
            * {t("keywords.part_1")} * {t("keywords.part_2")} * {t("keywords.part_3")} * {t("keywords.part_4")} *<br></br>* {t("keywords.part_5")} *
          {t("keywords.part_6")} * {t("keywords.part_7")} *<br></br>
          </h3>
          <p className='py-4'>
            {t("intro")}
          </p>
      ...
      <div className='z-10 flex flex-col max-w-5xl px-10 py-5 lg:px-0 lg:py-10'>
        ...
        <ul className='p-4 leading-10 text-2xl'>
          <li>
            ✨ {t("other.ig.part_1")}
            <Link  href='https://www.instagram.com/joanna.otmianowska/' className='underline'>
              {t("other.ig.link")}
            </Link>{' '}
          </li>
          <li>
